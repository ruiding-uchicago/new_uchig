...
<div class="row">
  ...
  <div class="col-10">
    ...
    <div class="alert alert-secondary" role="alert">
      <h3 class="text-center">Globus Portal Framework has been installed!</h3>

      <p class="text-center">You can checkout our demo index, or continue setting up your own from the README</p>
    </div>
    {% endif %}
